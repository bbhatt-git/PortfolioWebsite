...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    // Check for mobile to disable/adjust complex 3D
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Floating "App Icons" - Responsive Positioning */}
        <div className="absolute inset-0 pointer-events-none preserve-3d">
           {/* React Icon - Top Left */}
          <div className="absolute top-[0%] left-[2%] md:top-[5%] md:left-[10%] w-12 h-12 md:w-20 md:h-20 bg-white/80 dark:bg-[#1c1c1e]/80 backdrop-blur-md rounded-[14px] md:rounded-[18px] shadow-2xl flex items-center justify-center animate-float opacity-60 md:opacity-100" style={{ transform: isMobile ? 'none' : 'translateZ(40px)' }}>
              <i className="fab fa-react text-2xl md:text-4xl text-[#61DAFB] animate-spin-slow"></i>
          </div>
          
          {/* Code Icon - Bottom Right */}
          <div className="absolute bottom-[20%] right-[2%] md:bottom-[15%] md:right-[10%] w-14 h-14 md:w-24 md:h-24 bg-white/80 dark:bg-[#1c1c1e]/80 backdrop-blur-md rounded-[16px] md:rounded-[22px] shadow-2xl flex items-center justify-center animate-float animation-delay-2000 opacity-60 md:opacity-100" style={{ transform: isMobile ? 'none' : 'translateZ(60px)' }}>
        ...
        {/* Main Heading */}
        <div style={{ transform: isMobile ? 'none' : 'translateZ(50px)' }} className="mb-6 relative z-10 w-full max-w-4xl px-2">
          <Reveal delay={100}>
        ...
        <div style={{ transform: isMobile ? 'none' : 'translateZ(45px)' }} className="mb-8 md:mb-10 h-8 flex items-center justify-center w-full px-4">
           <Reveal delay={150}>
             <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-5 py-2 rounded-full bg-white/40 dark:bg-white/5 backdrop-blur-sm border border-black/5 dark:border-white/10 max-w-full overflow-hidden">
        ...
        <div style={{ transform: isMobile ? 'none' : 'translateZ(60px)' }}>
          <Reveal delay={300}>
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full px-8 sm:px-0">
              <a 
                href="#work" 
                className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm hover:scale-105 transition-transform duration-300 shadow-xl shadow-blue-500/30"
              >
                View Projects
              </a>
              <a 
                href="#contact" 
                className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-white/50 dark:bg-white/10 backdrop-blur-md border border-gray-200 dark:border-white/10 text-black dark:text-white font-semibold text-sm hover:bg-white dark:hover:bg-white/20 transition-all duration-300"
              >
                Get in Touch
              </a>
            </div>
