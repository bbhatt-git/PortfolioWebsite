...
// Extended list of floating icons for the background
const FLOATING_ICONS = [
  { icon: 'fab fa-python', color: 'text-yellow-500', position: 'bottom-[15%] left-[5%]', size: 'text-4xl md:text-6xl', animation: 'animate-float-slow', delay: '0s', rotate: '-rotate-12' },
  { icon: 'fab fa-react', color: 'text-blue-400', position: 'top-[12%] right-[5%]', size: 'text-5xl md:text-7xl', animation: 'animate-float-medium', delay: '1s', rotate: 'rotate-12' },
  { icon: 'fab fa-git-alt', color: 'text-red-500', position: 'top-[18%] left-[8%]', size: 'text-3xl md:text-4xl', animation: 'animate-float-fast', delay: '2s', rotate: '-rotate-6' },
  { icon: 'fab fa-js', color: 'text-yellow-400', position: 'bottom-[20%] right-[8%]', size: 'text-4xl md:text-5xl', animation: 'animate-float-slow', delay: '3s', rotate: 'rotate-6' },
  
  // New Icons
  { icon: 'fas fa-database', color: 'text-blue-500', position: 'top-[40%] left-[15%]', size: 'text-2xl md:text-3xl', animation: 'animate-float-medium', delay: '4s', rotate: 'rotate-12' },
  { icon: 'fab fa-node', color: 'text-green-500', position: 'bottom-[35%] right-[15%]', size: 'text-4xl md:text-5xl', animation: 'animate-float-fast', delay: '1.5s', rotate: '-rotate-12' },
  { icon: 'fab fa-figma', color: 'text-purple-500', position: 'top-[15%] left-[45%]', size: 'text-3xl md:text-4xl', animation: 'animate-float-slow', delay: '2.5s', rotate: 'rotate-3' },
  { icon: 'fab fa-docker', color: 'text-blue-600', position: 'bottom-[10%] left-[35%]', size: 'text-3xl md:text-4xl', animation: 'animate-float-medium', delay: '0.5s', rotate: 'rotate-6' },
  { icon: 'fab fa-aws', color: 'text-orange-500', position: 'top-[25%] right-[25%]', size: 'text-3xl md:text-4xl', animation: 'animate-float-slow', delay: '3.5s', rotate: '-rotate-6' },
  { icon: 'fab fa-html5', color: 'text-orange-600', position: 'top-[60%] left-[5%]', size: 'text-2xl md:text-3xl', animation: 'animate-float-fast', delay: '1.2s', rotate: 'rotate-12' },
  { icon: 'fab fa-css3-alt', color: 'text-blue-600', position: 'top-[65%] right-[5%]', size: 'text-2xl md:text-3xl', animation: 'animate-float-medium', delay: '2.8s', rotate: '-rotate-12' },
  { icon: 'fab fa-linux', color: 'text-gray-800 dark:text-gray-200', position: 'bottom-[45%] left-[80%]', size: 'text-3xl md:text-4xl', animation: 'animate-float-slow', delay: '4.5s', rotate: 'rotate-0' },
];
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
         {FLOATING_ICONS.map((icon, idx) => (
             <div 
                key={idx}
                className={`absolute ${icon.position} ${icon.animation} opacity-20 dark:opacity-10 hover:opacity-80 transition-opacity duration-500 will-change-transform`}
